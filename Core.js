...
return list[Math.floor(list.length * Math.random())]
 ...
 //Every Command Re-Organized by UnderTaker AKA AshAritra
...
『  *Java*  』⪼ 001.hyd.in.optik.host:27729  
『  *Bedrock*  』⪼ 001.hyd.in.optik.host 
『』*port*⪼ 27729 
『  *Version*  』⪼ 1.19.40
『  *No Beta version Allowed*  』
✨*support*✨⪼ crossplay , lagfree , multi-version, 24/7 !
` )
}
break
...
case 'music': case 'play': case 'song': case 'ytplay': {
 ...
 caption: `「  _MikuYoutube Player 2.0_  」
...
*Url :* ${anu.url}`,
 ...
 caption: `「  _MikuYoutube Downloader 2.0_  」
...
if (text) {
                ...
                await Miku.sendMessage(m.chat, { image: h })
                return
            }
            let qrbut = [{
                buttonId: `${prefix}qr`,
...
case '':
    ...
    if (isBanChat) return reply(mess.bangc)
      ...
      Mikupic ='https://wallpapercave.com/wp/wp8764182.jpg'
